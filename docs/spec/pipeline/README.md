...
2. [RouteClassifier](interfaces/route-classifier.md) groups those holds into one or more routes.
...
flowchart LR
    ...
    RCF[RouteClassifierFactory] --> RC[RouteClassifier]
    ...
    click RC "./interfaces/route-classifier.md"
    click RCF "./interfaces/route-classifier-factory.md"
...
| Route classification | [interfaces/route-classifier.md](interfaces/route-classifier.md) | Group detected holds into routes |
| Route classifier creation | [interfaces/route-classifier-factory.md](interfaces/route-classifier-factory.md) | Select/configure a route classifier implementation |
...
2. Implement protocols and factories for [HoldDetector](interfaces/hold-detector.md), [HoldDetectorFactory](interfaces/hold-detector-factory.md), [RouteClassifier](interfaces/route-classifier.md), and [RouteClassifierFactory](interfaces/route-classifier-factory.md).
